...
<!-- Css Styles -->
<link rel="stylesheet" href="/MovieWeb/views/lib/css/bootstrap.min.css"
	type="text/css">
<link rel="stylesheet"
...
<div id="loading" style="display: none" >
  <img src="https://i.gifer.com/ZZ5H.gif" height="50px">
	...
	<section class="product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-8" id="movie-all"></div>
							...
							<c:forEach var="item" items="${listTopView }">
								<div class="filter__gallery">
									<div class="product__sidebar__view__item set-bg mix day years"
										...
										<h5>
											<a href="/MovieWeb/moviedetails?movieId=${item.movieId }">${item.title }</a>
										</h5>
									</div>
							</c:forEach>
						</div>

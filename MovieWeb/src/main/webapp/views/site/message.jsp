...
<div class="d-flex justify-content-center" style="height: 300px;color: white;">
	<div>
		<div class="w-100 text-center">
		<h2 class="text-white mt-5">${message }</h2>
		<div class=" mt-4">
		<a class="site-btn" href="/MovieWeb/login"> Đăng nhập</a>
		</div>
		</div>

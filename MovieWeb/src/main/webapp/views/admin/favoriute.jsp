...
<body>
	...
	$(document).ready(function() {
		console.log('đã chạy')
		pagination(5,1,'${movieId}');
	});
	



function handleSizeChange(value,movieId) {
    // Gọi hàm pagination với giá trị mới được chọn
    pagination(value,1,movieId)
}


function pagination(size,page,movieId) {
	var size =size;
	var page = page;
var movieId = movieId
	 $.get('/MovieWeb/admin/getAllFavourite', {
	    	size:size,
	    	page:page,
	    	movieId:movieId
